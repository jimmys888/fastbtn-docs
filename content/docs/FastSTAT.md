...
## Overview
FastSTAT is an indicator designed to accompany FastBTN. With FastSTAT, you can see useful information directly on your chart, such as *total profit for current pair*, *total profit for all pairs*, *volumes*, *BEP Line*, and more. Let's go through them.

---

## Installation
The installation process is similar to [installing *FastBTN*](/docs/getting_started/#installation) with the following exceptions:
- The file name is `FastStat.ex5`
- In Step 4, you should copy `FastStat.ex5` into the `Indicators` folder, **NOT** the `Experts` folder.

---

## Configuration
![](/images/faststat-01.png)
...
2. **Show Price**\
   Displays the current pair's price.
